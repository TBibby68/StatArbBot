...
combined.to_sql('backtesting_data_prices_banks', engine, if_exists='replace', index=False)
combined_signal_gen_data.to_sql('backtesting_data_banks', engine, if_exists='replace', index=False)
